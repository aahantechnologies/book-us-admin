...
<div class="x_content">
  ...
  <form class="form-horizontal " role="form" method="post" name="availability_form" enctype="multipart/form-data">
								...
								<center><input type="submit" class="btn btn-success pull-right-container" name="s"  value="Add Category"></center>
								</div> </div> <br/>	 
									<br/>
...
if(isset($_REQUEST['s']))
{
  ...
  $res=move_uploaded_file($tmpname,$destination);
    extract($_REQUEST);
    $query="INSERT INTO `categories` (`id`, `parent_id`, `name`, `created`, `modified`, `status`) VALUES (NULL, '0', '$name', now(), now(), '1')";
