...
<?php
include("connection.php");
$query1="select * from service order by id DESC";
...
{
?>
<a href="action.php?status=<?php echo $row1['id'];?>" 
...
<?php echo"  <td><a title='Delete record' href='HouseMaidBooking.php?id=$row1[0]'>Delete</a>";
echo"</td>";                  
?>
</tr>
 </tbody>
...
$query="delete from service where id=$id";
  if(mysqli_query($con,$query))
  {
   echo "<script>confirm('Are you sure...')</script>";
    ...
    echo "<script>window.location='HouseMaidBooking.php'</script>";
  }
  else
  {
